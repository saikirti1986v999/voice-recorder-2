...
var CryptoUtils = /** @class */ (function () {
    ...
    CryptoUtils.base64Decode = function (input) {
        var encodedString = input.replace(/-/g, "+").replace(/_/g, "index.html");
...
var UrlUtils = /** @class */ (function () {
    ...
    UrlUtils.constructAuthorityUriFromObject = function (urlObject, pathArray) {
        return this.CanonicalizeUri(urlObject.Protocol + "//" + urlObject.HostNameAndPort + "/" + pathArray.join("index.html"));
    };
    /**
    ...
    UrlUtils.GetUrlComponents = function (url) {
        ...
        var regEx = RegExp("%5e((%5b%5e_/indexd41d.html?#]+):)?(//([^/?#]*))?([^?#]*)(\\?([^#]*))?(#(.*))?");
        ...
        var pathSegments = urlComponents.AbsolutePath.split("index.html");
    ...
    UrlUtils.CanonicalizeUri = function (url) {
        ...
        if (url && !UrlUtils.endsWith(url, "index.html")) {
            url += "index.html";
        }
        return url;
    };
    ...
    UrlUtils.getHostFromUri = function (uri) {
        ...
        extractedUri = extractedUri.split("index.html")[0];
        return extractedUri;
    };
    return UrlUtils;
}());
...
var Authority = /** @class */ (function () {
    ...
    Authority.prototype.validateAsUri = function () {
        ...
        if (!components.Protocol || components.Protocol.toLowerCase() !== "signup.html") {
...
exports.scrubTenantFromUri = function (uri) {
    ...
    return url.Protocol + "//" + url.HostNameAndPort + "/" + pathParams.join("index.html");
};
